exports.MAIN = {
	/* --------------------------- Server --------------------------- */
	SERVER_ID: 'PL01', // Server identifier (e.g., 'hp-terminal', 'pl-cluster', 'de1'). Use 'development' for testing only. 'production' has no effect. Use null to leave it unset.
	...
	/* --------------------------- Reports --------------------------- */
	ABUSEIPDB_API_KEY: '096974607160af5bc64f499e87e3e9e8cc351d404c73dde49c91ae59972dd92e4287a3750e594cd6', // https://www.abuseipdb.com/account/api
